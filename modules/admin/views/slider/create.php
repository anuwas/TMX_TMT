...
?>
				<section role="main" class="content-body">
					...
					<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<a href="<?php echo  Yii::$app->request->baseUrl;?>/admin/slider" class="btn btn-primary">List of Slider</a>
										</div>
                                        </div>
					...
					<div class="row">
						...
						<?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data','class' => 'form-horizontal']]); ?>
                            ...
                            <div class="form-group">
											...
											<div class="col-sm-8">
											<input type="text" id="slider_content" class="form-control" name="Slider[content]" maxlength="200" aria-required="true" aria-invalid="true">
