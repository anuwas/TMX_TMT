...
<header class="header">
				<div class="logo-container">
					<a href="<?php echo  Yii::$app->request->baseUrl;?>/admin" class="logo">
						<img height="45" width="100" alt="Benfed" src="<?php echo Yii::getAlias('@web').'/web/assets/admin/'?>icon/logo.png">	
                       </a>
						...
						<div class="nano-content">
							<nav id="menu" class="nav-main" role="navigation">
								<ul class="nav nav-main">
                                    ...
                                    <li class="nav-active">
                                    <a href="<?php echo  Yii::$app->request->baseUrl;?>/admin/product">
                                    ...
                                    <li class="nav-active">
                                    <a href="<?php echo  Yii::$app->request->baseUrl;?>/admin/clientlogo">
                                    ...
                                    <li class="nav-active">
                                    <a href="<?php echo  Yii::$app->request->baseUrl;?>/admin/interestcont">
                                    ...
                                    <li class="nav-active">
                                    <a href="<?php echo  Yii::$app->request->baseUrl;?>/admin/feedback">
                                    ...
                                    <li class="nav-active">
                                    <a href="<?php echo  Yii::$app->request->baseUrl;?>/admin/tmtvendor">
                                    <i class="fa fa-envelope" aria-hidden="true"></i>
                                    ...
                                    <li class="nav-active">
                                    <a href="<?php echo  Yii::$app->request->baseUrl;?>/admin/quickcon">
                                    <i class="fa fa-envelope" aria-hidden="true"></i>
                                    <span>Quick Contact Reports</span>										
                                    </a>		
                                    </li>
