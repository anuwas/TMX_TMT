...
<section class="body-sign">
			...
			<div class="center-sign">
				<a href="login" class="logo pull-left">
				<!--<img src="<?php echo Yii::getAlias('@web').'/web/assets/admin/'?>images/logo_new.png" alt="Dalmia" style="width:100%">-->
                <h1>TMX TMT Admin Panel</h1>
				</a>
				...
				<div class="panel panel-sign">
					...
					<div class="panel-body" style="padding:5px 33px 15px;">
                    <a href="login" class="" >
<img src="<?php echo Yii::getAlias('@web').'/web/assets/admin/'?>images/logo_new.png" alt="Benfed" style="display:block; margin:0 auto; width: 20%;" >
				</a>
